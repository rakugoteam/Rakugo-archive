...
#	"test skipping/auto":
	...
	if "Play Visual Novel example" == yield(Ren, "story_step"):
		Ren.jump("VisualNovelExample/Garden", "garden")
	
	if "Play Click'n'Point Adventure example" == yield(Ren, "story_step"):
		Ren.say({
				"who":
					"rench",
				"what":
	...
	if "Play RPG example" == yield(Ren, "story_step"):
		Ren.say({
			"who":
				"rench",
			"what":
	...
	if "Read Docs" == yield(Ren, "story_step"):
		Ren.say({
			"who":
				"rench",
			"what":
