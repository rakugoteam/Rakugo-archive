...
func _ready():
	...
	Rakugo.jump("Test/Test", "example", 0, false)
		...
		15:
			Rakugo.ask({
				"who": 
					"rakugoch",
				"what":
					"Hi! I'm [rakugoch.name]. What is your name?",
				"variable":
...
func play_vn_example(dialog_name):
	...
	Rakugo.jump("VisualNovelExample/Garden", "garden")
...
func play_cp_adv_example(dialog_name):	
	...
	Rakugo.jump("Test/Test", "end", 0, false)
	
func play_rpg_example(dialog_name):
	if Rakugo.currakugot_dialog_name == "Play RPG example":
		Rakugo.say({
			"who":
				"rakugoch",
			"what":
